...
- `[Stay tuned]` We are preparing to release 1.58-bit reasoning LLMs for a wide range of complex reasoning tasks, the CAT-Q/AYOT/ScaleQ-1.58 training code, etc.
- `[25/06/2026]` [The technical report](https://arxiv.org/abs/2608.01078) "**Attend to Your Own Thoughts: Breaking the Barrier for Post-Training Quantization of Reasoning LLMs through the Lens of 1.58-Bit Quantization**" is now available on arXiv.
...
- `[01/05/2026]` 🎉🎉🎉Our paper "**CAT-Q: Cost-efficient and Accurate Ternary Quantization for LLMs**" is accepted to ICML 2026 as an oral.
